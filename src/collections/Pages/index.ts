...
import { CallToActionConfig } from '@/components/blocks/call-to-action/config'
import { ContentConfig } from '@/components/blocks/content/config'
import { FormBlockConfig } from '@/components/blocks/form/config'
