...
import { FORM_FIELD_BLOCKS } from '@/lib/forms/puckFormBlocks'
...
export function getFormPuckBlockSchema(): PuckBlockSchema[] {
  return FORM_FIELD_BLOCKS.map(normalizeBlock)
}
